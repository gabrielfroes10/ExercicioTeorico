public class ExercicioTeorico {
     ...
     * Resposta: Letra A
     *
     * 3 - O Princípio da Responsabilidade Única (SRP) afirma que uma classe deve ter apenas uma razão para mudar.
     * Qual é o problema de uma classe que viola esse princípio?
     *
     * a) Baixa coesão
     * b) Alto acoplamento
